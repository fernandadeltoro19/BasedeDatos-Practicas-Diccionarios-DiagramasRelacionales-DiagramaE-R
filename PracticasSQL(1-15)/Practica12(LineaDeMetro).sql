...
USE master;
GO
IF DB_ID (N'LineaDeMetro') IS NOT NULL
	Drop DATABASE LineaDeMetro;
	GO
CREATE DATABASE LineaDeMetro

ON   
( NAME = LineaDeMetro_dat,  
    FILENAME = 'D:\BD\LineaDeMetro.mdf',  
    SIZE = 10,  
    MAXSIZE = 50,  
    FILEGROWTH = 5 )  
LOG ON  
( NAME = Sales_log,  
    FILENAME = 'D:\BD\LineaDeMetro.ldf',  
    SIZE = 5MB,  
    MAXSIZE = 25MB,  
    FILEGROWTH = 5MB );  
GO
